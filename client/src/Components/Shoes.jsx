...
function Shoes() {
  ...
  let {Shoes,AddToCart}=useContext(My_Context)
  ...
  return (
   <>
    <section className='container-fluid mb-lg-5'>
         <div className="container">
         <div className='text-center mt-4' id='mensectioncontent' data-aos="zoom-in-up"
        data-aos-duration='1500'>
         <h2 className='mb-0'>Step Into Comfort</h2>
         <h4>Walk with Confidence.</h4>
         </div>
         <div className="row">
          {
            Shoes.map((x,y)=>{
              return(
               ...
               data-aos-duration='1500'>
                ...
                <div className='categoryShoessec'>
                <h6>{x.ProductName}</h6>
